    ...
    <View style={styles.screenContainer}>
      <View style={[styles.container, styles.border]}>
        <View style={styles.profileContainer}>
          <Image
            source={{ uri: 'https://avatars.githubusercontent.com/u/136977742?s=96&v=4' }} // Ganti dengan URL gambar kamu
            style={styles.profileImage}
          />
          <Text style={styles.title}>Asep Saepuloh</Text>
        </View>
        <Text style={styles.text}>NIM: 222505007</Text>
      </View>
...
const HobbiesScreen = () => (
  <View style={styles.screenContainer}>
    <View style={[styles.container, styles.border]}>
      ...
      <Text style={styles.text}>1. Main game</Text>
      <Text style={styles.text}>2. Menyanyi</Text>
      <Text style={styles.text}>3. Memasak</Text>
    </View>
  </View>
);
...
const CustomDrawerContent = (props: DrawerContentComponentProps) => (
  <View style={{ flex: 1 }}>
    ...
    <View style={styles.drawerProfileContainer}>
      ...
      />
      <Text style={styles.drawerTitle}>Asep Saepuloh</Text>
    </View>
